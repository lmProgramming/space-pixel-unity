...
{
    public class GenerateModulePrefabs : EditorWindow
    {
        [MenuItem("Tools/Generate Module Prefabs")]
        public static void BuildPrefabs()
        {
            const string spriteDir = "Assets/Sprites/Generated/New";
            const string prefabDir = "Assets/Prefabs/Gameplay/Modules/New";
